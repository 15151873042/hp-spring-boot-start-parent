 ...
 * @Author Create By lijunhui 2016年11月30日 下午2:56:34
 * @Version v0.1
 */
public class ReflectionUtils {
    ...
    public static <T> Class<T> getMethodRtnClz(final Class<?> clz, final String methodName) {
        ...
        Class<T> rtn = (Class<T>) ((ParameterizedType) type).getActualTypeArguments()[0].getClass();
        return rtn;
    }
